function Handle = ObjectHandle(clientID,sim)
   ...
   %TargetHandles
    [~,TargetHandle(1,1)]=sim.simxGetObjectHandle(clientID,'dummy1',sim.simx_opmode_blocking);
    [~,TargetHandle(1,2)]=sim.simxGetObjectHandle(clientID,'dummy2',sim.simx_opmode_blocking);
    [~,TargetHandle(1,3)]=sim.simxGetObjectHandle(clientID,'dummy3',sim.simx_opmode_blocking);
